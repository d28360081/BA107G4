					...
					<div class="modal-footer">
						...
						<c:if
							...
							<form
								...
								method="post" onsubmit="return Send(this)">
								<div class="btn-group btn-group-lg">
									<input type="submit" value="發貨" class="btn btn-info">
									<input type="hidden" name="action"
										value="ChangeStoreOrder_sts_Send"> <input
										type="hidden" name="rec_id" value="${storeReceiptDetail.rec_id}">
								</div>
							</form>
						</c:if>
