...
<%
	String activeAddStore = "activeAddStore";
	request.setAttribute("activeAddStore", activeAddStore);
				...
				<div role="tabpanel">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li role="presentation" class="active"><a href="#tab1"
							aria-controls="tab1" role="tab" data-toggle="tab">新增商店</a></li>
					</ul>
										...
										<thead>
											<div role="tabpanel" class="tab-pane" id="tab1">
												<Form
													...
													<input type="hidden" name="action" value="AddPersonalStore">
													...
													<div class="textLeft PB">
														商店描述:
														<textarea class="form-control" rows="5" name="st_intro"></textarea>
													</div>
