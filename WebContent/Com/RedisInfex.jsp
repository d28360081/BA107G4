...
<head>
    ...
    <link rel="stylesheet" href="/BA107G4/css/base.css">
    <link rel="icon" href="/BA107G4/img/gogo.png">
    <link rel="stylesheet" href="/BA107G4/css/ComIndex.css">
    <style>
    .col-sm-4 img{
    width:275px;
    height:275px;
    ...
    var endPointURL = "ws://"+window.location.host+webCtx+"/TimeWs/${MemVO.mem_id}";
		...
		var websocket=new WebSocket(endPointURL);
		 ...
		 websocket.onmessage=function(e){	 
		  ...
		  if(msg.type=="ComeToVote"){
			 
			    fadeout(msg.com_id +'招募完成');
			  //解析Json物件
			  //用type做判斷
			  ...
			  document.getElementById("VoteLik").href=msg.editUri[0];
			  fadeout(msg.com_id +'招募完成,前往編輯頁面');    	 
			      }
			  ...
			  $("#modal-title").text(msg.com_id+'投票結束');
		      $("#voteuri").attr("href", msg.voteuri);
		      $("#voteuri").text("前往觀看");
		      $("#Votemodal").modal();
		   }
