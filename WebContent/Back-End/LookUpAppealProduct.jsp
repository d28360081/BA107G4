		...
		<tr>
			<Form action="${pageContext.request.contextPath }/EditProductServlet"
				...
				<input type="hidden" name="action"
					value="RealEditProductFromBack-End"> <input type="hidden"
					name="it_id" value="${product.it_id}"> <input type="hidden"
				...
				<td><div>
						<input disabled="disabled" class="form-control" type="text" name="it_name"
							value="${product.it_name}">
					</div></td>
				<td><div>
						<textarea disabled="disabled" class="form-control" rows="5" name="it_intro">${product.it_intro}</textarea>
					</div></td>
				<td><div>
						<input disabled="disabled" class="form-control" type="text" name="it_prc"
				...
				<td><div>
						<input disabled="disabled" class="form-control" type="text" name="it_num"
							value="${product.it_num}">
					</div></td>
				<td><div>
						<select disabled="disabled" name="it_sts" class="form-control toption_id "
							data="${product.it_id}">
				...
				<td><div>
						<select disabled="disabled" class="form-control" name="it_cate">
