    ...
    <div class="container">
        ...
        <div class="sidenav hoverable">
           ...
           <c:if test="${sessionScope.EmpVO ne null}">
            ...
            <c:if test="${EmpPmsVOAll.pmsid eq 'PMS002'}">
              <a href="<%=request.getContextPath() %>/com.mis.view/mis_index.jsp"> 任務管理</a>
            </c:if>
            ...
            <c:if test="${EmpPmsVOAll.pmsid eq 'PMS005'}">
                  ...
                  <div class="collapse" id="services">
                        ...
                        <a href="<%=request.getContextPath()%>/appeal/CommisionCommentAppeal.jsp">代購留言檢舉</a>
